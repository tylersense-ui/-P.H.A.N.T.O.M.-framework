 ...
 * ╠════════════════════════════════════════════════════════════════════╣
 * ║ CHANGELOG:                                                         ║
 * ║   v0.2.1 (2026-03-17) - HOTFIX: Fixed grow formula (serverGrowth) ║
...
export function calculateGrowThreads(server, player, currentMoney, targetMoney) {
    ...
    // NOTE: serverGrowth is already a multiplier (e.g., 3000), NOT a percentage
